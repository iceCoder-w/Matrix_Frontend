<template>
  <div :status="status" class="uploader-file">
    ...
    >
      <div :class="progressingClass" :style="progressStyle" class="uploader-file-progress"/>
      <div class="uploader-file-info">
        <div class="uploader-file-name"><i :icon="fileCategory" class="uploader-file-icon"/>{{ file.name }}</div>
        ...
        <div class="uploader-file-actions">
          ...
          <span class="uploader-file-resume" @click="resume"/>
